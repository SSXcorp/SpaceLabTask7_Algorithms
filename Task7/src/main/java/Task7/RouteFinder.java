...
public class RouteFinder<T extends GraphNode> {
    ...
    public List<T> findRoute(T from, T to) {
        Map<T, RouteNode<T>> allNodes = new HashMap<>(); // Карта каждого узла в котором написано что мы о нем знаем
        Queue<RouteNode> openSet = new PriorityQueue<>(); // Базовый набор узлов, которые мы можем рассматривать как следующий шаг
